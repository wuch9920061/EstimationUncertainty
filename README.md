This project aims to quantify estimation uncertainty (a part of epistemic uncertainty that is due to the use of limited ground motion sets). The source codes are programmed in R.
